...
| 8 | **D-20(c) Per-printer camera selection holds** — switch between the two printers; each retains its own preferred cam (WR-03 null-key edge) | ✅ PASS | ✅ RESOLVED 2026-06-11 | Cross-printer hold owner-verified live at the 26.5 UAT sitting (flox, both printers on LAN, E3 mid-print): cam selected on E5+ → switch to E3 → switch back → selection held. Closes the 2026-06-08 deferral. (Original note: single-printer hold passed on E5+; two-printer switch awaited a second live instance.) |
