 ...
 * [SpineHandle.sessionInstanceId][works.mees.dinghy.di.SpineHandle.sessionInstanceId] is UNCHANGED across
...
class ServiceSurvivesRotationTest {
    ...
    private fun waitForSpine(): works.mees.dinghy.di.SpineHandle? {
