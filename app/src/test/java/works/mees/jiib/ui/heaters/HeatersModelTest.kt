...
class HeatersModelTest {
    ...
    private val caps = works.mees.jiib.state.Capabilities(
        objects = setOf("extruder", "heater_bed"),
    )
    private val noBed = works.mees.jiib.state.Capabilities(objects = setOf("extruder"))
    private val presets = listOf(
        works.mees.jiib.config.HeatPreset("p1", "PLA", mapOf("extruder" to 200, "heater_bed" to 60)),
        works.mees.jiib.config.HeatPreset("p2", "Bed only", mapOf("heater_bed" to 50)),
    )
