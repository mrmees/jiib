...
class NavDestRoundTripTest {
    ...
    fun calibrationRoutineToNavDest_coversAllRoutines() {
        ...
        val mapped = works.mees.dinghy.calibration.CalibrationRoutine.values().map { it.toNavDest() }.toSet()
