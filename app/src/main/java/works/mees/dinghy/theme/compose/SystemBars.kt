 ...
 * contrast + the pre-API-35 bar colors) to the ACTIVE [works.mees.dinghy.theme.ThemeTokens], never
 * the system uiMode.
 *
 ...
 *  - [works.mees.dinghy.theme.ThemeTokens] carries NO dark/light flag (the resolver's `dark`
 ...
 *
 * `Color.luminance()` is pure host-testable math (precedent: [works.mees.dinghy.theme.brandTint]
