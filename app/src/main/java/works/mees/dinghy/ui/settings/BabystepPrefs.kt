 ...
 *
 * Copies the [works.mees.dinghy.ui.macros.MacroPrefs] / [works.mees.dinghy.config.ConnectionStore] shape
 ...
 * goes through [works.mees.dinghy.di.AppContainer.setBabystepEnabled] / `setBabystepLayers`, which launch
