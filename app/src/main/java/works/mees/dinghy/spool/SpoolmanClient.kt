 ...
 * [works.mees.dinghy.ui.files.FileBrowserClient]'s "interface of suspend reads returning
 ...
 * session via [works.mees.dinghy.spool.ActiveSpoolFacade]. INVENTORY is Spoolman-owned and rides the
 ...
 * [works.mees.dinghy.command.CommandDispatcher]: these are reads, not fire-and-forget actions, and the
