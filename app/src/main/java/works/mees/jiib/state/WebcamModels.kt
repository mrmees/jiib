 ...
 * field is nullable-or-defaulted and NEVER fabricated — mirroring [works.mees.jiib.ui.move.MoveVm]'s
 ...
 * derive transform ([works.mees.jiib.net.deriveNativeStreamUrl]) takes this as a parameter to choose
 ...
 * [works.mees.jiib.ui.move.MoveVm]'s "resolved VM for the screen" role. Carries the chosen [Webcam],
