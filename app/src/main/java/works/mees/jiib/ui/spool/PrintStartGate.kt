 ...
 * [works.mees.jiib.ui.files.deleteAllowed] — same directory, same pure-predicate role — except this
 ...
 * shows unchanged). No Android, no I/O, fully unit-testable ([works.mees.jiib.spool.PrintStartGateTest]).
 *
