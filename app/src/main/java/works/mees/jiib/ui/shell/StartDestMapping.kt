 ...
 * The extra crosses the EXPORTED-[works.mees.jiib.MainActivity] trust boundary, so its value is UNTRUSTED
 ...
 * ([works.mees.jiib.di.AppContainer.devCyclerEnabled]) is the FIRST line of defense (release-inert);
