...
import works.mees.jiib.command.HistoryListArgs
...
import works.mees.jiib.di.SessionControl
...
import works.mees.jiib.net.SocketEvent
import works.mees.jiib.state.ConnectionState
import works.mees.jiib.state.PrinterStateStore
import works.mees.jiib.ui.printstatus.LastJobHolder
import works.mees.jiib.ui.printstatus.PrintMetadataHolder
import works.mees.jiib.spool.ActiveSpoolFacade
import works.mees.jiib.spool.MoonrakerSpoolmanClient
import works.mees.jiib.ui.files.MoonrakerFileBrowserClient
import works.mees.jiib.webcam.WebcamsHolder
...
class MoonrakerService : Service() {
    ...
    private fun buildSpineAndLaunch(cfg: ConnectionConfig): Pair<Job, Long> {
        ...
        container.publishSystemInfoHolder(
            works.mees.jiib.systeminfo.SystemInfoHolder(
                scope = serviceScope,
                spine = handle,
