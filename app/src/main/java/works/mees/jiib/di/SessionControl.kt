 ...
 * session ONLY through this interface. It deliberately exposes NO member that returns
 ...
 *    the current [works.mees.jiib.command.CommandDispatcher] (debounce + in-flight + timeout for free).
 */
