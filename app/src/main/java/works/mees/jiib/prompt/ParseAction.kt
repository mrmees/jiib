 ...
 * this project's tolerant-total-parser idiom ([works.mees.jiib.ui.spool.scan.parseSpoolId] /
 * [works.mees.jiib.ui.console.ConsoleSeverity.classify]): NO I/O, NO coroutines, NO Compose — same
