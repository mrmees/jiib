 ...
 * morphs into the e-stop while printing (see [works.mees.jiib.designsystem.components.FocusFrame]).
 ...
 * in [works.mees.jiib.ui.shell.AppShell] and positively gated to those fallback destinations — so it
 ...
 * @param onClick  invoked on tap — callers should present a [works.mees.jiib.designsystem.ConfirmGuard]
