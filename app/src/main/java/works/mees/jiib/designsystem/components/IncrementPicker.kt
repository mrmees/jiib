 ...
 *
 * ## Height cap (UAT-5)
 * The row is exactly [uDp] tall — the unit-grid U from [works.mees.jiib.designsystem.layout.rememberUnitGrid].
 * Never hardcode a Dp height (use [uDp] instead).
 *
 * ## Intent law (D-20) + selection fill (2026-06-13 UAT)
 * Active increment = [Intent.Accent] outline + [works.mees.jiib.theme.ThemeTokens.accentSoft]
