 ...
 * [works.mees.jiib.preview.SampleFixtures.spoolList] fixture, so the selection matrix is driven by a
 ...
 * to a [works.mees.jiib.preview.PreviewPlaceholderBox] (the same D-05 idiom as the 18-02 classic-View
