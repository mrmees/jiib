...
import works.mees.jiib.ui.webcam.WebcamVm

/**
 * @Preview matrix for [WebcamScreen] (25-06 / D-19 / D-20).
 *
 * ## Feed surface is preview-safe (D-05)
 * Both [works.mees.jiib.render.Media3SurfaceHost] (H.264 rung) and
 * [works.mees.jiib.render.WebcamViewHost] (MJPEG/Snapshot rung) already guard with
 ...
 * fixtures — no [works.mees.jiib.ui.webcam.WebcamHolder], no `collectAsStateWithLifecycle`,
 ...
 * the Back FootButtonBar sits full-width below the feed (CR-02 full-focus rule).
