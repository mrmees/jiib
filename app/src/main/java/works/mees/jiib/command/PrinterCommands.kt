 ...
 * the [works.mees.jiib.state.deriveCapabilities] purity discipline: NO I/O, NO coroutines, NO Compose;
 ...
 * ([works.mees.jiib.net.JsonRpcMethods.GCODE_SCRIPT]); [scriptParams] wraps a string into the
