 ...
 * theme (D-08) persisted as PRIMITIVES (never a baked [works.mees.jiib.theme.ThemeTokens]).
 *
...
data class Profile(
     ...
     * per-entry). NEVER throws, NEVER bakes a [works.mees.jiib.theme.ThemeTokens].
     */
