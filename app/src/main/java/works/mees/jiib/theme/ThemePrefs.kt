 ...
 * the [works.mees.jiib.theme.ThemeResolver] → [Palette.generate] boundary (DEFAULT_POOL_MAX_ITEMS=4).
 *
...
class ThemePrefs(
     ...
     * the resolver's [works.mees.jiib.theme.ThemeResolver.DEFAULT_POOL_MAX_ITEMS] boundary constant.
     */
