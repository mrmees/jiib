 ...
 * mirroring [works.mees.jiib.state.Webcam]'s tolerant `@Serializable`/`@SerialName` discipline and
 ...
 * `safeRotation`/`hasSnapshot` precedent on [works.mees.jiib.state.Webcam]).
 */
@Serializable
