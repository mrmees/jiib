 ...
 * [works.mees.dinghy.bench.BenchActivity] (the Compose [works.mees.dinghy.render.ProgressRing] + the
 * classic-Views [works.mees.dinghy.render.GraphView], both fed by the deterministic ~3 Hz
 ...
 * AUTHORITATIVE on-device metric is the raw `dumpsys gfxinfo works.mees.dinghy framestats` CSV,
...
class RenderBenchmark {
    ...
    companion object {
        ...
        private const val TARGET_PACKAGE = "works.mees.dinghy"
        private const val BENCH_ACTIVITY = "works.mees.dinghy.bench.BenchActivity"
